...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	// 데이터로 인스턴스 배열을 로드합니다.
	instances[0].position = XMFLOAT3(-3.f, -1.f, 5.0f);
	instances[1].position = XMFLOAT3(-1.f, -1.f, 5.0f);
	instances[2].position = XMFLOAT3(1.f, -1.f, 5.0f);
	instances[3].position = XMFLOAT3(3.f, -1.f, 5.0f);
	instances[4].position = XMFLOAT3(0.f, 1.f, 5.0f);

...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 첫 번째 조명 객체를초기화합니다.
	m_Light1->SetDiffuseColor(0.45f, 0.0f, 0.0f, 1.0f);
	//m_Light1->SetPosition(0.f, 1.f, 0.f);
	...
	// 두 번째 조명 객체를 초기화합니다.
	m_Light2->SetDiffuseColor(0.0f, 0.f, 0.45f, 1.0f);
	//m_Light2->SetPosition(0.f, 1.f, 0.f);
	...
	// 세 번째 조명 객체를 초기화합니다.
	m_Light3->SetDiffuseColor(0.0f, 0.45f, 0.f, 1.0f);
	//m_Light3->SetPosition(0.f, 1.f, 0.f);
	...
	// 네 번째 조명 객체를 초기화합니다.
	m_Light4->SetDiffuseColor(0.45f, 0.f, 0.f, 1.0f);
	//m_Light4->SetPosition(0.f, 1.f, 0.f);
	...
	// 네 번째 조명 객체를 초기화합니다.
	m_Light5->SetDiffuseColor(1.f, 1.f, 1.f, 1.0f);
	m_Light5->SetPosition(0.f, 1.f, 0.f);
	//m_Light5->SetPosition(3.0f, 1.0f, -3.0f);
...
bool GraphicsClass::Render()
{
	...
	worldMatrix = XMMatrixRotationY(m_Angle);

...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return InitializeShader(device, hwnd, L"../Dx11Demo_38/color_vs.hlsl", L"../Dx11Demo_38/color_hs.hlsl", L"../Dx11Demo_38/color_ds.hlsl", L"../Dx11Demo_38/color_ps.hlsl");
}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* hsFilename, const WCHAR* dsFilename, const WCHAR* psFilename)
{

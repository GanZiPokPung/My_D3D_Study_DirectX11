...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), L"../Dx11Demo_24/data/seafloor.dds", "../Dx11Demo_24/data/cube.txt"))
	{
...
bool GraphicsClass::Frame()
{
	...
	m_Camera->SetRotation(90.f, -30.f, 90.f);
...
{
	// 클리핑 면을 설정합니다.
	XMFLOAT4 clipPlane = XMFLOAT4(-1.0f, -1.0f, -1.0f, 0.0f);

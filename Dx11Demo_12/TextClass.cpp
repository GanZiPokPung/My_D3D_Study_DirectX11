	...
	XMMATRIX baseViewMatrix)
{
	...
	result = UpdateSentence(m_sentence1, "Hello", 100, 100, 1.0f, 0.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "World", 100, 200, 1.0f, 0.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}

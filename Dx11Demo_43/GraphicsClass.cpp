...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	m_ViewPoint->SetLookAt(1.0f, 1.0f, 1.0f);
	m_ViewPoint->SetProjectionParameters((float)(XM_PI / 2.0f), 1.0f, 0.1f, 1000.0f);
...
bool GraphicsClass::Render()
{
	...
	rotationMatrix = XMMatrixRotationY(m_Angle * (180 / XM_PI));
